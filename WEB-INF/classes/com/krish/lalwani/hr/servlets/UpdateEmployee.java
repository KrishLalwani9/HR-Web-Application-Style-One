...
if(panNumber.equalsIgnoreCase(employeeDTO.getPANNumber()));
else panNumberExists=employeeDAO.panNumberExists(panNumber);
boolean aadharCardNumberExists=false;
if(aadharCardNumber.equalsIgnoreCase(employeeDTO.getAadharCardNumber()));
else aadharCardNumberExists=employeeDAO.aadharCardNumberExists(aadharCardNumber);
...
sendBackView(response,daoException);
return;
}
pw.println("<!DOCTYPE HTML>");
pw.println("<html lang='en'>");
...
pw.println("<!-- right panel starts here -->");
pw.println("<div style='height:65vh;margin-top:5px;margin-bottom:5px;margin-left:105px;margin-right:5px;padding:5px;border:1px solid black'>");
pw.println("<h3>Notification</h3><br>");
pw.println("Employee Updated<br>");
pw.println("<form action='/styleone/employeesView'>");
pw.println("<button type='submit'>Ok</button>"); //style='float:left' is removed
pw.println("</form>");
pw.println("</div> <!-- right panel ends here -->");
pw.println("</div> <!-- conten-section ends here -->");
pw.println("<!-- footer starts here -->");
