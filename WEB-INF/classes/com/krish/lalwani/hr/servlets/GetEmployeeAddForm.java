...
pw.println("<td>");
pw.println("<input type='checkbox' id='isIndian' name='isIndian' value='Yes'>");
pw.println("</td>");
pw.println("</tr>");
pw.println("<tr>");
pw.println("<td>Basic Salary</td>");
pw.println("<td>");
pw.println("<input type='text' style='text-align:right' id='basicSalary' name='basicSalary' maxlength='11' size='13'>");
